...
def Registration():
    while(True):
        ...
        if email in registration_email:
            ...
            while(True):
                num = input("Enter '1' for try again and '2' for login: \n")
                if num.isalpha():
...
def Generate_Question():
    ...
    for k in range(len(quiz1)):
        ...
        while(True):
            ...
            if answ.isalpha() or answ < '0' or answ > '3':
...
if __name__ == "__main__" :
    while(True):
        print("Enter '1 for registration' , '2 for login':")
        num = input()
        if num.isalpha():
            ...
            Generate_Question()
            while(True):
                gen = input("Do you want to generate 5 question again . Presss 'y' for Yes and 'n' for No exit: \n").lower()
                while(True):
